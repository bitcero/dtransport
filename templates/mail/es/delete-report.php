                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:0px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                            ...
                            <div align="center" class="img-container center fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                                ...
                                <div style="line-height:25px;font-size:1px">&#160;</div>  <img class="center fullwidth" align="center" border="0" src="<?php echo $moduleUrl; ?>/images/rounder-up.png" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                            ...
                            <div align="center" class="img-container center" style="padding-right: 0px;  padding-left: 0px;">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                                <img class="center" align="center" border="0" src="<?php echo $moduleUrl; ?>/images/divider.png" alt="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 316px" width="316">
                                <!--[if mso]></td></tr></table><![endif]-->
                            </div>
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Hola Administrador. Esta recibiendo este mendaje debido a que el proceso de mantenimiento de D-Transport, con fecha <strong><?php echo $logDate; ?></strong>&#160;ha eliminado algunas descargas de la base de datos de <strong>D-Transport</strong>. A continuación se muestra la lista de las descargas eliminadas.<span style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"><strong><br></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">&#160;</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div style="color:#555555;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                                    <table cellpadding="5" cellspacing="0" style="width: 100%; border: 0;">
                                        <thead>
                                        <tr>
                                            <th style="border-bottom: 1px solid rgba(0,0,0,0.1);"><?php __('Descarga', 'dtransport'); ?></th>
                                            <th style="border-bottom: 1px solid rgba(0,0,0,0.1); text-align: center;"><?php __('Estado', 'dtransport'); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <?php foreach($deletedItems as $item): ?>
                                        <tr>
                                            <td style="border-bottom: 1px solid rgba(0,0,0,0.1);"><strong><?php echo $item['name']; ?></strong></td>
                                            <td style="border-bottom: 1px solid rgba(0,0,0,0.1); text-align: center;"><span style="color: <?php echo $item['result'] == 'fail' ? '#BF2D1D' : '#189F3F'; ?>"><?php echo $item['result'] == 'success' ? $item['status'] : __('Failed', 'dtransport'); ?></span></td>
                                        </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 18px">Toma en cuenta que has elegido el método <?php $deletionMethod; ?>&#160;para procesar la eliminación de descargas de la base de datos. Si deseas cambiar este comportamiento entonces ve a la configuración de&#160;<span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true"><strong>﻿D-Transport</strong><span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true">﻿, dentro de la sección "<span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true"><em>﻿Maintenance</em><span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true">﻿", y cambia el método de eliminación.</span></span></span></span></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                ...
                <div class="col num12" style="min-width: 320px;max-width: 600px;width: 600px;width: calc(28000% - 167400px);background-color: transparent;">
                    <div style="background-color: transparent; width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                            ...
                            <div align="center" class="img-container center fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                                <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding-right: 0px; padding-left: 0px;" align="center"><![endif]-->
                                <img class="center fullwidth" align="center" border="0" src="<?php echo $moduleUrl; ?>/images/rounder-dwn.png" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: 0;height: auto;float: none;width: 100%;max-width: 600px" width="600">
                                <!--[if mso]></td></tr></table><![endif]-->
                            </div>
