                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">Hello Admin. You are receiving this message due to the maintenance process from <strong><?php echo $logDate; ?></strong>&#160;has removed some items from tthe <strong>D-Transport</strong> database. Below is the list of items that has been removed.<span style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"><strong><br></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">&#160;</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div style="color:#555555;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;">
                                    <table cellpadding="5" cellspacing="0" style="width: 100%; border: 0;">
                                        <thead>
                                        <tr>
                                            <th style="border-bottom: 1px solid rgba(0,0,0,0.1);"><?php __('Item', 'dtransport'); ?></th>
                                            <th style="border-bottom: 1px solid rgba(0,0,0,0.1); text-align: center;"><?php __('Status', 'dtransport'); ?></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 18px">Note that you has been choosed the method <?php $deletionMethod; ?>&#160;for remove items from database. If you wish to change this behaviour then go to configuration of&#160;<span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true"><strong>﻿D-Transport</strong><span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true">﻿, under "<span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true"><em>﻿Maintenance</em><span style="font-size: 12px; line-height: 18px;" id="_mce_caret" data-mce-bogus="true">﻿" section and change deletion method.</span></span></span></span></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
