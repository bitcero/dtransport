                    ...
                    <div style="background-color: transparent; width: 100% !important;">
                        <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:0px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#555555; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">You have not updated your download <a href="<?php echo $itemUrl; ?>" style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"><strong><?php echo $itemName; ?></strong></a> for a while, and now is in risk to be deactivated.<span style="color: rgb(168, 191, 111); font-size: 14px; line-height: 21px;"><strong><br></strong></span></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">&#160;<br></p><p style="margin: 0;font-size: 14px;line-height: 21px;text-align: center">We want to keep our database as up to date as possible; because of that, we need to verify that your download item&#160;information is up to date.</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div style="font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;line-height:150%;color:#0D0D0D; padding-right: 10px; padding-left: 10px; padding-top: 20px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:18px;color:#0D0D0D;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 18px;text-align: center"><span style="font-size: 16px; line-height: 24px;">YOU ARE RECEVING THIS <strong>ALERT</strong> BECAUSE YOU HAVE NOT UPDATED THE <span style="color: rgb(168, 191, 111); line-height: 24px; font-size: 16px;"><strong><?php echo strtoupper($itemName); ?></strong></span> DATA FOR MORE THAN <strong><?php echo $limitDays; ?></strong> DAYS</span>.</p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            <div align="center" class="button-container center" style="padding-right: 10px; padding-left: 10px; padding-top:25px; padding-bottom:10px;">
                                ...
                                <div style="color: #ffffff; background-color: #a8bf6f; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; max-width: 166px; width: 136px; width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 15px; padding-right: 15px; padding-bottom: 15px; padding-left: 15px; font-family: 'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; text-align: center; mso-border-alt: none;">
                                    <span style="font-size:12px;line-height:24px;"><a href="<?php echo $itemEdit; ?>" style="font-size: 18px; line-height: 36px;" data-mce-style="font-size: 18px; line-height: 32px;">UPDATE&#160;NOW!</a></span>
                                </div>
                            ...
                            <div style="color:#555555;line-height:120%;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif; padding-right: 10px; padding-left: 10px; padding-top: 10px; padding-bottom: 10px;">
                                <div style="font-size:12px;line-height:14px;color:#555555;font-family:'Montserrat', 'Trebuchet MS', 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', Tahoma, sans-serif;text-align:left;"><p style="margin: 0;font-size: 12px;line-height: 14px;text-align: center"><span style="font-size: 14px; line-height: 16px; color: rgb(153, 51, 0);"><strong>WARNING:</strong></span><span style="font-size: 14px; line-height: 16px; color: rgb(153, 51, 0);">﻿ After <strong><?php echo $deleteDays; ?></strong> days this download will be deactivated and deleted if it is not updated.</span></p></div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
